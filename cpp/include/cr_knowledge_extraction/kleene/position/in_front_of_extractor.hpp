...
class InFrontOfExtractor : public KleeneExtractor {
  public:
    InFrontOfExtractor(std::shared_ptr<knowledge_extraction::env_model::EnvironmentModel> env_model)
        : KleeneExtractor(std::move(env_model), Proposition::IN_FRONT_OF) {}
