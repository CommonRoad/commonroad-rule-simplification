...
if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.23.0)
    install(TARGETS cr_knowledge_extraction
            EXPORT ${export_name}
...
foreach(fc_target Eigen3 spdlog boost_src)
...
set(cr_knowledge_extraction_install_cmakedir ${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME})
set(cr_knowledge_extraction_config_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}Config.cmake)
set(cr_knowledge_extraction_version_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}ConfigVersion.cmake)

configure_package_config_file(
        ${PROJECT_SOURCE_DIR}/cmake/${PROJECT_NAME}Config.cmake.in
        ${cr_knowledge_extraction_config_file}
        INSTALL_DESTINATION ${cr_knowledge_extraction_install_cmakedir}
)

write_basic_package_version_file(
        ${cr_knowledge_extraction_version_file}
        COMPATIBILITY AnyNewerVersion
)

install(FILES ${cr_knowledge_extraction_config_file}
        ${cr_knowledge_extraction_version_file}
        DESTINATION  ${cr_knowledge_extraction_install_cmakedir}
)
